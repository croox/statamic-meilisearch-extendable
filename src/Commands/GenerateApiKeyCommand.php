...
namespace Croox\StatamicMeilisearchExtendable\Commands;
...
class GenerateApiKeyCommand extends Command
{
    ...
    public function __construct(
        private readonly IndexNamePrefix $indexNamePrefix,
    ) {
        parent::__construct();
    }
    ...
    private function keyProperties(): array
    {
        ...
        $indexNames = [ $this->indexNamePrefix->prefixedIndexName([ ]) . '*' ];
